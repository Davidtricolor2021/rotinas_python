        ...
        for arquivo in caminho_origem: # encontrou arquivo i: 'NVR_ch1_main_20221220114000_20221220115000.dav'
            ...
            if flg_movimento==0:
                ...
                self.process = (
                    ...
                    .output(self.arquivo_saida, pix_fmt='yuv420p', vcodec='libx264', crf=21)
                    .overwrite_output()
                    ...
                    if contador_lote == 10:
                        ...
                        if detected_motion:
                            ...
                            for i in vetor_frames:
                                num_frame_movi += 1
                                #cv2.putText(i, str(num_frame_movi), (600, 340), 0, 0.3, [255, 255, 255], thickness=1,lineType=cv2.LINE_AA)
